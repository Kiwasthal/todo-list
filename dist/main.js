...
const appModule = (() => {
  _information_module__WEBPACK_IMPORTED_MODULE_0__.informationModule.grabElement('projectHeader')
    .addEventListener('click', _controller_module__WEBPACK_IMPORTED_MODULE_1__.controllerModule.headerControl);
  _information_module__WEBPACK_IMPORTED_MODULE_0__.informationModule.grabElement('projectIcon')
    .addEventListener('click', _controller_module__WEBPACK_IMPORTED_MODULE_1__.controllerModule.headerControl);
  _information_module__WEBPACK_IMPORTED_MODULE_0__.informationModule.grabElement('toDoButton')
    .addEventListener('click', _controller_module__WEBPACK_IMPORTED_MODULE_1__.controllerModule.toDoControl);
  _information_module__WEBPACK_IMPORTED_MODULE_0__.informationModule.grabElement('barsIcon')
    .addEventListener('click', _display_module__WEBPACK_IMPORTED_MODULE_2__.displayModule.toggleSideNav);
  _information_module__WEBPACK_IMPORTED_MODULE_0__.informationModule.grabElement('dropIcon')
    .addEventListener('click', _display_module__WEBPACK_IMPORTED_MODULE_2__.displayModule.dropIconToggle);
  _information_module__WEBPACK_IMPORTED_MODULE_0__.informationModule.grabElement('today')
    .addEventListener('click', _display_module__WEBPACK_IMPORTED_MODULE_2__.displayModule.createTodayDisplay);
})();
...
const controllerModule = (() => {
  ...
  if (localStorage.getItem('mylocalStore') === null) {
    ...
    _information_module__WEBPACK_IMPORTED_MODULE_2__.informationModule.projectsLibrary = JSON.parse(
  ...
  let updateLocalStorage = () => {
    localStorage.setItem(
      'mylocalStore',
      JSON.stringify(_information_module__WEBPACK_IMPORTED_MODULE_2__.informationModule.projectsLibrary)
    );
  ...
  let createToDo = () => {
    ...
    if (
      (0,date_fns__WEBPACK_IMPORTED_MODULE_3__["default"])((0,date_fns__WEBPACK_IMPORTED_MODULE_4__["default"])(todoDate)) &&
      (0,date_fns__WEBPACK_IMPORTED_MODULE_5__["default"])(new Date()) !== (0,date_fns__WEBPACK_IMPORTED_MODULE_5__["default"])((0,date_fns__WEBPACK_IMPORTED_MODULE_4__["default"])(todoDate))
    ) {
      confirmation = false;
    ...
    for (let i = 0; i < _information_module__WEBPACK_IMPORTED_MODULE_2__.informationModule.projectsLibrary.length; i++) {
      for (
        let y = 0;
        y < _information_module__WEBPACK_IMPORTED_MODULE_2__.informationModule.projectsLibrary[i].todoLibrary.length;
        y++
      ) {
        if (
          _information_module__WEBPACK_IMPORTED_MODULE_2__.informationModule.projectsLibrary[i].todoLibrary[y].toDoTitle ===
          todoTitle
        ) {
    ...
    if (confirmation) {
      for (let i = 0; i < _information_module__WEBPACK_IMPORTED_MODULE_2__.informationModule.projectsLibrary.length; i++) {
        if (
          _information_module__WEBPACK_IMPORTED_MODULE_2__.informationModule.projectsLibrary[i].title ===
          _information_module__WEBPACK_IMPORTED_MODULE_2__.informationModule.grabElement('projectSelect').value
        ) {
  ...
  let openProjectModal = () => {
    ...
    _information_module__WEBPACK_IMPORTED_MODULE_2__.informationModule.grabElement('closeModal')
    ...
    _information_module__WEBPACK_IMPORTED_MODULE_2__.informationModule.grabElement('createProject')
  ...
  let headerControl = () => {
    ...
    _information_module__WEBPACK_IMPORTED_MODULE_2__.informationModule.grabElement('addProject')
  ...
  let toDoControl = () => {
    ...
    _information_module__WEBPACK_IMPORTED_MODULE_2__.informationModule.grabElement('createToDo')
...
const displayModule = (() => {
  ...
  let createProjectIcon = () => {
    ...
    _information_module__WEBPACK_IMPORTED_MODULE_1__.informationModule.grabElement('projectsBar')
      .insertBefore(
        myProjectIcon,
        _information_module__WEBPACK_IMPORTED_MODULE_1__.informationModule.grabElement('projectHeader')
      );
  };
  ...
  let resetAnimation = () => {
    _information_module__WEBPACK_IMPORTED_MODULE_1__.informationModule.grabElement('displayInfo')
  ...
  let dropIconToggle = () => {
    if (
      _information_module__WEBPACK_IMPORTED_MODULE_1__.informationModule.grabElement('dropIcon')
  ...
  let toggleSideNav = () => {
    if (
      _information_module__WEBPACK_IMPORTED_MODULE_1__.informationModule.grabElement('sideNav').classList.contains('sidenavHide')
    ) {
    ...
    _information_module__WEBPACK_IMPORTED_MODULE_1__.informationModule.projectsLibrary.forEach((project) => {
      if (project.title === e.target.textContent) {
        ...
        for (let i = 0; i < project.todoLibrary.length; i++) {
          ...
          todoDate.textContent = (0,date_fns__WEBPACK_IMPORTED_MODULE_12__["default"])(
  ...
  let createTodayDisplay = () => {
    ...
    for (let i = 0; i < _information_module__WEBPACK_IMPORTED_MODULE_1__.informationModule.projectsLibrary.length; i++) {
      for (
        let y = 0;
        y < _information_module__WEBPACK_IMPORTED_MODULE_1__.informationModule.projectsLibrary[i].todoLibrary.length;
        y++
      ) {
        if (
          (0,date_fns__WEBPACK_IMPORTED_MODULE_13__["default"])(
            (0,date_fns__WEBPACK_IMPORTED_MODULE_14__["default"])(_information_module__WEBPACK_IMPORTED_MODULE_1__.informationModule.projectsLibrary[i].todoLibrary[y].date),
            new Date()
          )
        ) {
          let todoContainer = document.createElement('div');
          ...
          todoContainer.style.borderLeftColor = assignPriorityColor(
            _information_module__WEBPACK_IMPORTED_MODULE_1__.informationModule.projectsLibrary[i].todoLibrary[y].priority
          );

          todoHeader.textContent =
            _information_module__WEBPACK_IMPORTED_MODULE_1__.informationModule.projectsLibrary[i].todoLibrary[y].toDoTitle;
          todoDate.textContent = (0,date_fns__WEBPACK_IMPORTED_MODULE_12__["default"])(
            new Date(_information_module__WEBPACK_IMPORTED_MODULE_1__.informationModule.projectsLibrary[i].todoLibrary[y].date),
            'MM/dd/yyyy'
          );
          ...
          myDeleteIcon.dataset.index =
            _information_module__WEBPACK_IMPORTED_MODULE_1__.informationModule.projectsLibrary[i].todoLibrary[y].index;
          imageContainer.appendChild(myDeleteIcon);
  ...
  let updateProjectsMainDisplay = () => {
    ...
    _information_module__WEBPACK_IMPORTED_MODULE_1__.informationModule.projectsLibrary.forEach((project) => {
      ...
      deleteProject.addEventListener('click', (e) => {
        ...
        for (let i = 0; i < _information_module__WEBPACK_IMPORTED_MODULE_1__.informationModule.projectsLibrary.length; i++) {
          if (
            _information_module__WEBPACK_IMPORTED_MODULE_1__.informationModule.projectsLibrary[i].title.replace(/\s/g, '') ===
            check
          ) {
            const index = _information_module__WEBPACK_IMPORTED_MODULE_1__.informationModule.projectsLibrary.indexOf(
              _information_module__WEBPACK_IMPORTED_MODULE_1__.informationModule.projectsLibrary[i]
            );
...
const informationModule = (() => {
  ...
  //The worst idea I ever had;//At least i could convert argument with some kind of ${} convention but i had to be silly.
